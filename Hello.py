    ...
    if opcao_selecionada == 'editar':
        ...
        if not df.empty:
            ...
            situacao_edit = st.selectbox('Situação*', 
                            options=['', 'Encaminhado para Secretário(a) da CPC', 'Análise Equipe 1', 'Análise Equipe 2', 'Análise Equipe 3', 'Análise Equipe 4', 'Aguardando Assinaturas', 'Encaminhado para a PP1'], 
